...
//   // Update Donut Data
//   const updateDonutData = (labels, data) => {
//     setDonutData({
//       labels: [...labels],
//       datasets: [
//         {
...
//     fetchProductsData();
//     fetchMonthlySalesData();
//     fetchDonutChartData(); // Fetch Donut Chart Data
//   }, []);
...
//   // Fetching Donut Chart Data
//   const fetchDonutChartData = () => {
//     fetch(`http://localhost:4000/api/sales/getdonutdata`)
//       .then((response) => response.json())
//       .then((datas) => {
//         const labels = datas.map((item) => item.label);
//         const data = datas.map((item) => item.value);
//         updateDonutData(labels, data);
//       })
//       .catch((err) => console.log(err));
//   };
//   return (
